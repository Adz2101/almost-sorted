...
<script>
    function showRiskMapping() {
        ...
        } else if (category === "Communications security") {
            addOption(riskMappingDropdown, "Phishing attacks");
            addOption(riskMappingDropdown, "Insecure wireless Networks");
            addOption(riskMappingDropdown, "Social Engineering attacks");
            addOption(riskMappingDropdown, "Malware");
        } else {
